#!/usr/bin/env bash
# escalabilidade forte: tamanho fixo, threads 1, 2, 4, 6, 8, 10, 12.
# 10 repeticoes. o ponto de 1 thread e o binario sequencial
# (-fopenmp -DSEQ_ONLY), nao o omp com OMP_NUM_THREADS=1.
set -eu
cd "$(dirname "$0")/.."
